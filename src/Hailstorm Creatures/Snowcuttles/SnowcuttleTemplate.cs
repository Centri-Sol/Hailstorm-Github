...
{
    public virtual string IconSpriteName => "Kill_Snowcuttle_Le";
    ...
    {
        Icon = new SimpleIcon(IconSpriteName, SnowcuttleColor);
    ...
    public override void EstablishRelationships()
    {
        ...
        scTempRelation.IntimidatedBy(new("InfantAquapede"), 1);

...
public class Snowcuttle : InsectoidCreature
{
    public readonly bool? gender;
    public CicadaAI AI;
    public struct IndividualVariations
    {
        public Snowcuttle owner;
        ...
        public IndividualVariations(Snowcuttle Snwctl, float defaultWingDeployment, float tentacleLength, float tentacleThickness, float wingThickness, float wingLength, int bustedWing)
        {
        ...
        public void GenerateColor(Snowcuttle Snwctl)
        {
            float hue;
        ...
        public void GenerateFatness(Snowcuttle Snwctl)
        {
            switch (Snwctl.gender)
            {
                case null: // Le
        ...
        public void GenerateWingPitch(Snowcuttle Snwctl)
        {
            if (Snwctl is null)
            {
...
&& Climbable(AI.pathFinder.GetDestination.Tile);
    ...
    public Snowcuttle(AbstractCreature absSnwctl, World world) : base(absSnwctl, world)
    {

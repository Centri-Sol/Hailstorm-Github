...
internal sealed class GorditoGreenieCritob : Critob
{
    ...
    public override void EstablishRelationships()
    {
        ...
        elGordito.Eats(DLCSharedEnums.CreatureTemplateType.AquaCenti, 1);
        ...
        elGordito.Eats(DLCSharedEnums.CreatureTemplateType.MotherSpider, 1);
        ...
        elGordito.Eats(DLCSharedEnums.CreatureTemplateType.ScavengerElite, 1);
        elGordito.Eats(MoreSlugcatsEnums.CreatureTemplateType.ScavengerKing, 1);
        elGordito.Eats(DLCSharedEnums.CreatureTemplateType.Yeek, 1);
        ...
        elGordito.Eats(DLCSharedEnums.CreatureTemplateType.ZoopLizard, 0.5f);
        ...
        elGordito.Attacks(DLCSharedEnums.CreatureTemplateType.MirosVulture, 1);
        ...
        elGordito.Rivals(DLCSharedEnums.CreatureTemplateType.SpitLizard, 1);
        elGordito.Rivals(MoreSlugcatsEnums.CreatureTemplateType.TrainLizard, 1);
        elGordito.Rivals(DLCSharedEnums.CreatureTemplateType.MotherSpider, 0.5f);
        elGordito.Rivals(CreatureTemplate.Type.GreenLizard, 0.25f);

        // Does nothing on its own.
        elGordito.IntimidatedBy(DLCSharedEnums.CreatureTemplateType.BigJelly, 0.25f);
        elGordito.IntimidatedBy(DLCSharedEnums.CreatureTemplateType.StowawayBug, 0.5f);

        elGordito.Fears(CreatureTemplate.Type.BigEel, 1);
        elGordito.Fears(DLCSharedEnums.CreatureTemplateType.Inspector, 1);
        elGordito.Fears(DLCSharedEnums.CreatureTemplateType.TerrorLongLegs, 1);
        ...
        elGordito.Ignores(DLCSharedEnums.CreatureTemplateType.JungleLeech);
        ...
        elGordito.AttackedBy(DLCSharedEnums.CreatureTemplateType.ScavengerElite, 0.75f);
        ...
        elGordito.AttackedBy(DLCSharedEnums.CreatureTemplateType.MirosVulture, 0.4f);
        ...
        elGordito.FearedBy(DLCSharedEnums.CreatureTemplateType.MotherSpider, 0.5f);
        ...
        elGordito.IgnoredBy(DLCSharedEnums.CreatureTemplateType.JungleLeech);
